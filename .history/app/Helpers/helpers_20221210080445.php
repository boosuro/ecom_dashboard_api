...
function getMediaColumnResource($mediaModel, $mediaCollectionName = '')
{
    ...
    if ($mediaModel->hasMedia($mediaCollectionName)) {
        return "<a href='" .  $mediaModel->getFirstMediaUrl($mediaCollectionName) . "' data-lightbox='OrdersPackPHPTest' title='Product Image'><img style='width:50px' src='" . asset($mediaModel->getFirstMediaUrl($mediaCollectionName)) . "' alt='Product Image'></a>";
    }
}
