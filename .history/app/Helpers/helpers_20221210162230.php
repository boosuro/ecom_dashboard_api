...
function getVariants($product)
{
    ...
    foreach ($product_variants as $var) {
        $variants .= "<button style='position:relative;background-color:$color;color:#fff;padding:4px 7px 4px 7px;border-radius:10px;font-weight:bold;margin:5px'>" . $var->variant_name . "</button>";
    }
