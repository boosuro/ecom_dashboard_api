...
function getMediaColumnResource($mediaModel, $mediaCollectionName = '')
{
    ...
    if ($mediaModel->hasMedia($mediaCollectionName)) {
        return "<a href='" .  asset($mediaModel->getFirstMediaUrl($mediaCollectionName)) . "' data-lightbox='OrdersPackPHPTest' title=''><img style='width:50px' src='" . asset($mediaModel->getFirstMediaUrl($mediaCollectionName)) . "' alt=''></a>";
    }
}
