...
function getVariants($product)
{
    ...
    foreach ($product_variants as $var) {
        $color_rand = $colors[array_rand($colors)];
        $variants .= "<span style='background-color:$color_rand;color:#000;padding:4px 7px 4px 7px;border-radius:10px;font-weight:bold;margin-right:5px'>" . $var->variant_name . "</span>";
    }
