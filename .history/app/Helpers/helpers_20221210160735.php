...
function getVariants($product)
{
    ...
    foreach ($product_variants as $var) {
        $variants .= "<span style='position:relative;background-color:$color;color:#000;padding:4px 7px 4px 7px;border-radius:10px;font-weight:bold;margin-top:10px'>" . $var->variant_name . "</span>";
    }
