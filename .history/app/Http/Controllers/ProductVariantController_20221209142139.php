...
class ProductVariantController extends Controller
{
    ...
    public function __construct(ProductVariantRepository $productVariantRepository, ProductVariantRepository $variantGroupRepository)
    {
     ...
     *
     */
    public function edit(ExtractionRequest $request, ProductVariant $variantgroup)
    {
        $validated_data = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ProductVariantRequest $request, ProductVariant $variantgroup)
    {
