...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $pie_data = json_encode([
            ...
            ['name' => 'Variant Groups', 'y' => $variant_groups, 'sliced' => true, 'selected' => true],
        ]);
        ...
        return view('dashboard.index', compact('users', 'products', 'variants', 'variant_groups', 'pie_data', 'products_list', 'products_names_list'));
    }
}
