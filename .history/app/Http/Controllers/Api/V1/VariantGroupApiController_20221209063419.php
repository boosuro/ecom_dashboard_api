...
class VariantGroupApiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $variantgroup = $this->variantGroupRepository->create(array_merge($validator->validated(), ['description' => $request->get('description')]));
    ...
    public function update(Request $request, VariantGroup $variantGroup)
    {
        ...
        $variantGroup->update(array_merge($validator->validated(), ['description' => $request->get('description')]));
