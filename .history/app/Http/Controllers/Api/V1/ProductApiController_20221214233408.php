...
class ProductApiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->only('name', 'price', 'quantity', 'product_variants', 'image'), [
            ...
            'product_variants' => 'required|min:1',
        ...
        $product_variants = explode(',', $validator->validated()['product_variants']);
        ...
        $product->variants()->attach($product_variants);
    ...
    public function update(Request $request, Product $product)
    {
        ...
        $product_variants = explode(',', rtrim($validator->validated()['product_variants'], ","));

        $product->variants()->sync($product_variants);
