...
class ProductApiController extends Controller
{
    ...
    public function __construct(ProductRepository $productRepositoryEloquent)
    {
    ...
    public function index()
    {
        ...
        $products = $this->productRepositoryEloquent->all();

        // dd($products->toArray());

        return $this->sendResponse(new ProductResource($product), 'Products retrieved successfully', 200);
    }
    ...
    public function store(Request $request)
    {
        ...
        // Create Product
        $product = $this->productRepositoryEloquent->create(array_merge(
            $validator->validated(),
            ['user_id' => auth()->id()]
        ));
