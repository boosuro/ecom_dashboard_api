    ...
    <div class="col-lg-12 card-margin">
        ...
        <div class="card">
            ...
            <div class="card-header " style="border: none">
                <h5 class="card-title" style="color:#000">{{ ucfirst(str_replace('-',' ',$module)) }} List</h5>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        @if ($title != "")
                        {# <button type="button"
                            onclick="customCrud({url:'{{ route($module.'.create') }}',holder:'{{ ucfirst($module) }}',action:'Add', this_ : this});"
