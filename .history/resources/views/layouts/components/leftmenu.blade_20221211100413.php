            ...
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard') }}" data-toggle="tooltip" data-placement="right"
                        title="Quick Link - Dashboard" data-original-title="Quick Link - Dashboard"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('users.index') }}" data-toggle="tooltip" data-placement="right"
                        title="Quick Link - Users" data-original-title="Quick Link - Users"
                        data-skin-class="tooltip-base">
                        <i data-feather="user-plus"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('variantgroup.index') }}" data-toggle="tooltip"
                        data-placement="right" title="Quick Link - Product Variant Group"
                        data-original-title="Quick Link - Product Variant Group" data-skin-class="tooltip-base">
                        <i data-feather="grid"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('productvariant.index') }}" data-toggle="tooltip"
                        data-placement="right" title="Quick Link - Product Variant"
                        data-original-title="Quick Link - Product Variant" data-skin-class="tooltip-base">
                        <i data-feather="list"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('product.index') }}" data-toggle="tooltip" data-placement="right"
                        title="Quick Link - Products" data-original-title="Quick Link - Products"
                        data-skin-class="tooltip-base">
                        <i data-feather="activity"></i>
                    </a>
                </li>
                <li class="nav-item" style="cursor: pointer">
                    <a class="nav-link" href="{!! url('/logout') !!}" title="Quick Link - Logout"
                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                        data-toggle="tooltip" data-placement="right" data-original-title="Quick Link - Logout"
                        data-skin-class="tooltip-base">
