                ...
                <div class="col-md-12">
                    <div class="cardm">
                        <div class="card-content">
                            ...
                            @if ($action=="Add")
                                {{ Form::open(['route' => Str::lower($module).'.store','method' => 'post', 'enctype' => 'multipart/form-data']) }}
                            @else
                                {{ Form::model($model, ['route' => [Str::lower($module).'.update', $model->id], 'method' => 'patch','enctype' => 'multipart/form-data']) }}
                            @endif
