<div class="row ">
    <div class="col-md-6">
        ...
        {{ Form::text('name', null, ['class' => 'form-control','placeholder'=> Variant Group Name]) }}
    </div>
    <div class="col-md-6">
        {{ Form::label('name', trans('lang.description'), ['class' => 'control-label']) }} <span
...
<div class="row">
    <div class="col-md-6">
        {{ Form::label('name', trans('lang.cover_image'), ['class' => 'control-label']) }} <span
            style="color: rgb(228,49,112);font-size: 20px;">*</span>
...
<div class="row">
    <div class="col-lg-12">
        <button type="submit" class="btn btn-primary btn-rose pull-right "> {{ Str::lower($btn_action_title) == 'add' ?
            trans('lang.category_add') : trans('lang.category_update') }} </button>
    </div>
</div>
