...
<div class="row">
    <div class="col-lg-4 card-margin " style="margin-bottom: 33px;">
        <div class="card "
            style=" background: linear-gradient(60deg, #765fff, #a115ff)!important;box-shadow: 0 10px 30px -12px rgba(0, 0, 0, 0.42), 0 4px 25px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);">
    ...
    <div class="col-lg-4 card-margin" style="margin-bottom: 33px;">
        <div class="card"
            style="background: linear-gradient(60deg, #aa0dff, #4765ff)!important;box-shadow: 0 10px 30px -12px rgba(0, 0, 0, 0.42), 0 4px 25px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);">
            <div class="card-header card-header-icon" data-background-color="purple"
                style="width: 80px;height: 80px;border: none;background-color:#8530ff;">
