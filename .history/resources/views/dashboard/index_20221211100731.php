<div class="row">
    <div class="col-lg-4 card-margin " style="margin-bottom: 33px;">
        <div class="card " style=" background: linear-gradient(60deg, #765fff, #a115ff)!important;box-shadow: 0 10px 30px -12px rgba(0, 0, 0, 0.42), 0 4px 25px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);">
            <div class="card-header card-header-icon" data-background-color="purple" style="width: 80px;height: 80px;border: none;">
                <i class="material-icons" style="margin-left: 7px;margin-top: 2px;">groups</i>
            </div>
            <div class="card-header no-border" style="border-bottom:none!important;background-color: rgb(0 0 0 / 0.0);display: block;!important;">
    ...
    <div class="col-lg-4 card-margin" style="margin-bottom: 33px;">
        <div class="card" style="background: linear-gradient(60deg, #aa0dff, #4765ff)!important;box-shadow: 0 10px 30px -12px rgba(0, 0, 0, 0.42), 0 4px 25px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);">
            <div class="card-header card-header-icon" data-background-color="purple" style="width: 80px;height: 80px;border: none;">
                    ...
                    <div class="carousel-inner" style="overflow: visible;">
                        <div class="carousel-item active">
                            <div class="widget-3" style="margin-top: -45px;">
                                ...
                                <div class="widget-3-statistics">
                                    <div class="widget-3-figure" style="text-align: right;">
                                        <span style="color: #fff"><?php echo $total_system_users ?></span>
                                    </div>
                                    <div class="widget-3-title" style="color: #fff">
