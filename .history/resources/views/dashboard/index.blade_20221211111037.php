...
<script>
    $(function () {
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Active Point Stock Summary as of <?php echo date("F d, Y h:i:s A"); ?>'
            },
            subtitle: {
                text: ''
            },
            xAxis: {
                categories: <? php echo json_encode($products_list_name); ?>,
            crosshair: true
        },
            yAxis: {
            min: 0,
            ...
            series: [{
                name: 'Quantity Sold',
                data: <? php echo json_encode($products_list_sold); ?>

            }, {
        name: 'Quantity Unsold',
        data: <? php echo json_encode($products_list_unsold); ?>
