...
<div class="col-md-6" style="margin-top: -10px;">
    {{ Form::label('name', 'Select All Product Variants', ['class' => 'control-label']) }} <span
        style="color: rgb(228,49,112);font-size: 20px;">*</span>
    {!! Form::select('productvariants[]', $product_variants, $selected_product_variants, ['class' => 'selectpicker
    form-control '
    ,'data-style'=>'btn btn-primary btn-round','multiple'=>'multiple','data-live-search'=>'true','tabindex' =>'-98'])
    !!}
</div>
</div>
<br>
...
<div class="row">
    <div class="col-lg-12">
        <button type="submit" class="btn btn-primary btn-rose pull-right "> {{ Str::lower($btn_action_title) == 'add' ?
            'Add Product Variant' : 'Update Product Variant' }} </button>
    </div>
</div>
