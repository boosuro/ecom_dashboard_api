        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        @if ($title != "")
                            <button type="button"  onclick="customCrud({url:'{{ route(strtolower($module).'.create') }}',holder:'{{ ucfirst($module) }}',action:'Add', this_ : this});"   class="btn btn-primary btn-round pull-left" style="float: left">{{ $title }}</button>
                        @endif
                    </div>
                </div>
                <br><br>
